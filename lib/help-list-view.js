...
export default class HelpListView {
  ...
  constructor (S) {
    ...
    this.slv.element.classList.add('sofistik-help')

    this.disposables = new CompositeDisposable()
    this.disposables.add(
      atom.commands.add(this.slv.element, {
        'SOFiSTiK-help:open-in': () => this.didConfirmSelection(null, 'open-in'),
        'SOFiSTiK-help:open-ex': () => this.didConfirmSelection(null, 'open-ex'),
      }),
