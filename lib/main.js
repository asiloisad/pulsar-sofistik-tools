  ...
  activate () {
    ...
    this.disposables.add(
      ...
      atom.commands.add('.tree-view', {
        ...
        'sofistik-tools:clean-small':
          () => this.cleanSelectedFolders('11'),
        'sofistik-tools:clean-small-recursively':
          () => this.cleanSelectedFolders('21'),
        'sofistik-tools:clean-medium':
          () => this.cleanSelectedFolders('12'),
        'sofistik-tools:clean-medium-recursively':
          () => this.cleanSelectedFolders('22'),
        'sofistik-tools:clean-large':
          () => this.cleanSelectedFolders('13'),
        'sofistik-tools:clean-large-recursively':
          () => this.cleanSelectedFolders('23'),
        'sofistik-tools:clean-max':
          () => this.cleanSelectedFolders('14'),
        'sofistik-tools:clean-max-recursively':
