...
export default {
  config: {
    envPath: {
      ...
      description: "Open help on the page with the current key. In most cases you want use this, but not all PDF viewer in atom support it. The supported and recommended PDF viewer is [pdf-viewer](https://atom.io/packages/pdf-viewer). The option can be activated only for inner PDF viewers",
      order: 4,
      default: false,
    },
  },
