...
export default {
  ...
  activate (_state) {
    ...
    subscriptions.add(atom.commands.add('atom-text-editor[data-grammar="source sofi"]', {
        ...
        'SOFiSTiK-atom:PROG-all-1'         : () => this.changeProg1('all'),
        'SOFiSTiK-atom:PROG-all-0'         : () => this.changeProg0('all'),
        'SOFiSTiK-atom:PROG-above-toggle'  : () => this.changeProg ('above'),
        'SOFiSTiK-atom:PROG-above-1'       : () => this.changeProg1('above'),
        'SOFiSTiK-atom:PROG-above-0'       : () => this.changeProg0('above'),
        'SOFiSTiK-atom:PROG-below-toggle'  : () => this.changeProg ('below'),
        'SOFiSTiK-atom:PROG-below-1'       : () => this.changeProg1('below'),
        'SOFiSTiK-atom:PROG-below-0'       : () => this.changeProg0('below'),
