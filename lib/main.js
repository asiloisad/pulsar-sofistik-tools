...
export default {
  ...
  openInSofistikProgram(prog, ext, filePath, props) {
  ...
  openAnimator(filePath, props) {
    return openInSofistikProgram('animator.exe', '.cdb', filePath, props)
  },

  openReport(filePath, props) {
    return openInSofistikProgram('ursula.exe', '.plb', filePath, props)
  },
  ...
  openViewer(filePath, props) {
    return openInSofistikProgram('fea_viewer.exe', '.cdb', filePath, props)
  },

  openDBNG(filePath, props) {
    return openInSofistikProgram('dbinfo_ng.exe', '.cdb', filePath, props)
  },

  openSSD(filePath, props) {
    return openInSofistikProgram('ssd.exe', '.sofistik', filePath, props)
  },

  openWinGRAF(filePath, props) {
    return openInSofistikProgram('wingraf.exe', '.gra', filePath, props)
  },

  openResultViewer(filePath, props) {
    return openInSofistikProgram('resultviewer.exe', '.results', filePath, props)
  },

  openTeddy(filePath, props) {
    return openInSofistikProgram('ted.exe', '.dat', filePath, props)
  },

  openSOFiPLUS(filePath, props) {
    return openInSofistikProgram('sofiplus_launcher.exe', '.dwg', filePath, props)
  },

  openExportCDB(filePath, props) {
    return openInSofistikProgram('export.exe', '.cdb', filePath, props)
  },
