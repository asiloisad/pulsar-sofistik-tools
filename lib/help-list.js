  ...
  constructor (S) {
    ...
    this.slv = new SelectListView({
      ...
      elementForItem: (item, props) => {
        ...
        matches = this.query.length>0 ? atom.ui.fuzzyMatcher.match(item.displayName, this.query, { recordMatchIndexes:true }).matchIndexes : []
    ...
    this.disposables.add(
      ...
      atom.commands.add('atom-workspace', {
        ...
        'sofistik-tools:cache-help': () => { this.items=null ; this.update() },
      }),
    )
  }
