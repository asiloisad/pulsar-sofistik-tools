...
export default class VersListView {
  ...
  constructor () {
    this.selectListView = new SelectListView({
      ...
      infoMessage: 'Select new default SOFiSTiK version',
      ...
      didConfirmSelection: (version) => {
        atom.config.set('sofistik-tools.version', version.displayName)
        this.hide()
      },
  ...
  async show () {
    ...
    if (atom.config.get('command-palette.preserveLastSearch')) {
    ...
    await this.selectListView.update({items: items})
